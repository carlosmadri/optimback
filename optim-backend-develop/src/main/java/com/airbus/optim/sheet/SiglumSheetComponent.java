...
public class SiglumSheetComponent {
    ...
    public void createSiglumSheet(Workbook workbook, String userSelected) {
        ...
        editableSiglums.sort(Comparator.comparing(
                workload -> workload.getSiglumHR() != null && workload.getSiglumHR() != null
                        ? workload.getSiglumHR()
                        : "")
        );

        int rowIdx = 1;

        for (Siglum siglum : editableSiglums) {
