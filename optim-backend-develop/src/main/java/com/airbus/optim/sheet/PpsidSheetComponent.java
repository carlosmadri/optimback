...
public class PpsidSheetComponent {
    ...
    public void createPpsidSheet(Workbook workbook) {
        ...
        ppsids.sort(Comparator.comparing(
                ppsid -> ppsid.getPpsidName() != null ? ppsid.getPpsidName() : ""));
        ...
        for (PPSID ppsid : ppsids) {
            ...
            row.createCell(9).setCellValue(ppsid.getScenario() != null ? ppsid.getScenario() : null);
        }
